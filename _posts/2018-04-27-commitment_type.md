...
rather than an actual measurement from a past year. The details of these Business as Usual projections 



Certain of the least developed nations with the lowest carbon intensive economies (co2/GDP/capita) and fewer resources focused on reforms that indirectly impacted greenhouse gas emissions. As a group they tended to favor such low-cost initiatives as reforestation, adopting new land use policies, household-scale solar electrification in rural areas or agreeing to a maximum carbon intensity.



the varying conditions of each nation and incorporated a diversity of strategies 
